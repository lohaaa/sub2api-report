...
printf '%s  sub2api-report-server-v1.0.3-linux-amd64.tar.gz\n' \
...
case "$url" in
  */releases/latest)
    printf 'https://github.com/lohaaa/sub2api-report/releases/tag/v1.0.3'
    ;;
  */sub2api-report-server-v1.0.3-linux-amd64.tar.gz)
...
grep -q '^Release resolved: v1.0.3$' "$test_root/output.log"
