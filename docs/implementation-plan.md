...
| M9 稳定版加固 | `v1.0.0` - `v1.0.2` | 已完成 | Updater 安全验收和 Release workflow 全部通过；v1.0.2 提供带断点续传和进度显示的精简 systemd 直接部署包 |
...
- `v1.0.2` 为 Latest，Release workflow 完成质量、Docker 镜像、共享 Runtime server package、Critical 扫描、SBOM、签名、attestation 和两类 smoke test；
- `v1.0.2` 包含 13 项 Release Assets，server artifact 为 56,016,652 bytes，checksum 为 `89a222e50ff95a11806913ca98576656f3f26982c96354f7cb81bcc165e8ed83`。
