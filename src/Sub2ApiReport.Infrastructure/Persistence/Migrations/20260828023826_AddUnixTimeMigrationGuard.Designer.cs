...
namespace Sub2ApiReport.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828023826_AddUnixTimeMigrationGuard")]
    partial class AddUnixTimeMigrationGuard
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Notifications.NotificationChannel", b =>
                {
                    ...
                    b.Property<long?>("LastTestedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.DeliveryPart", b =>
                {
                    ...
                    b.Property<long?>("SentAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.ReportGenerationRun", b =>
                {
                    ...
                    b.Property<long?>("CompletedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.ReportRun", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CollectingAt")
                        .HasColumnType("TEXT");

                    b.Property<long?>("CollectingAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTimeOffset?>("DeliveringAt")
                        .HasColumnType("TEXT");

                    b.Property<long?>("DeliveringAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTimeOffset?>("RenderingAt")
                        .HasColumnType("TEXT");

                    b.Property<long?>("RenderingAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ReportSnapshotId", "StartedAtUnixMilliseconds");

                    b.HasIndex("ScheduleId", "StartedAtUnixMilliseconds");

                    b.ToTable("ReportRuns", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReportRuns_Attempt", "Attempt > 0");

                            t.HasCheckConstraint("CK_ReportRuns_Completion", "(Status IN ('Succeeded', 'PartialFailed', 'Failed') AND CompletedAt IS NOT NULL) OR (Status NOT IN ('Succeeded', 'PartialFailed', 'Failed') AND CompletedAt IS NULL)");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Security.RecoveryChallenge", b =>
                {
                    ...
                    b.Property<long?>("LockedUntilUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Sub2Api.ExternalApiKey", b =>
                {
                    ...
                    b.Property<long?>("LastSeenAtUnixMilliseconds")
                        .HasColumnType("INTEGER");

                    b.Property<DateTimeOffset?>("LastUsedAt")
                        .HasColumnType("TEXT");

                    b.Property<long?>("LastUsedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long?>("RetiredAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Sub2Api.Sub2ApiConnection", b =>
                {
                    ...
                    b.Property<long?>("LastSynchronizedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long?>("LastUsersSynchronizedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.System.SystemSetting", b =>
                {
                    ...
                    b.Property<long?>("InitializedAtUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Infrastructure.Identity.Administrator", b =>
                {
                    ...
                    b.Property<long?>("LockoutEndUnixMilliseconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Sub2ApiReport.Infrastructure.Persistence.UnixTimeMigrationState", b =>
                {
                    ...
                    b.ToTable("UnixTimeMigrationState", (string)null);
