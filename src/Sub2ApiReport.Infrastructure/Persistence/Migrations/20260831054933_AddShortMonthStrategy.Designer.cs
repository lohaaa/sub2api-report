...
namespace Sub2ApiReport.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260831054933_AddShortMonthStrategy")]
    partial class AddShortMonthStrategy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.ReportDownloadGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long?>("LastDownloadedAt")
                        .HasColumnType("INTEGER")
                        .HasColumnName("LastDownloadedAtUnixMilliseconds");
                    ...
                    b.HasIndex("ReportSnapshotId", "CreatedAt");

                    b.ToTable("ReportDownloadGrants", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReportDownloadGrants_DownloadCount", "DownloadCount >= 0 AND (MaxDownloads IS NULL OR (MaxDownloads > 0 AND DownloadCount <= MaxDownloads))");

                            t.HasCheckConstraint("CK_ReportDownloadGrants_LifetimeHours", "LifetimeHours BETWEEN 1 AND 720");
                        });
                });
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.ReportSchedule", b =>
                {
                    ...
                    b.Property<string>("ShortMonthStrategy")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ReportSchedules", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReportSchedules_DayOfMonth", "DayOfMonth BETWEEN 1 AND 31");
                            ...
                            t.HasCheckConstraint("CK_ReportSchedules_ShortMonthStrategy", "ShortMonthStrategy IN ('UseLastDay', 'SkipMonth')");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.System.SystemSetting", b =>
                {
                    ...
                    b.Property<int>("ReportDownloadLinkHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(24);

                    b.Property<int?>("ReportDownloadMaxDownloads")
                        .HasColumnType("INTEGER");

                    b.Property<string>("ReportExternalBaseUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Sub2ApiReport.Domain.Reports.ReportDownloadGrant", b =>
                {
                    b.HasOne("Sub2ApiReport.Domain.Reports.DeliveryRecord", "Delivery")
                        .WithOne("DownloadGrant")
                        .HasForeignKey("Sub2ApiReport.Domain.Reports.ReportDownloadGrant", "DeliveryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sub2ApiReport.Domain.Reports.ReportSnapshot", "ReportSnapshot")
                        .WithMany()
