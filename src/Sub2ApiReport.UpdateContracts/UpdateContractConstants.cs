...
public static class UpdateContractConstants
{
    ...
    public const string AppRoleLabelKey = "io.sub2api-report.role";
    ...
    public const string InstanceLabelKey = "io.sub2api-report.instance";

    /// <summary>升级操作标签键，用于在替换与回滚期间定位候选容器。</summary>
    public const string UpgradeOperationLabelKey = "io.sub2api-report.upgrade-operation";

    public const string ContractLabelKey = "io.sub2api-report.contract";
    public const string MaintenanceOperationEnvironmentKey = "Update__MaintenanceOperationId";
    ...
    public const string AppDataMountTarget = "/data";
}
